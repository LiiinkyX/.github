<div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background: #0d1117; color: #c9d1d9; border-radius: 12px; padding: 30px; max-width: 800px; margin: auto; box-shadow: 0 8px 20px rgba(0,0,0,0.5);">

  <h1 style="color: #58a6ff; font-size: 2.5em; margin-bottom: 10px;">🔗 Lynky — Connect Beyond Random</h1>

  <p style="font-size: 1.1em; line-height: 1.6; color: #adbac7;">
    <strong>Lynky</strong> is a next-generation social chat platform inspired by Omegle — but built <em>smarter</em>, <em>deeper</em>, and <em>more human</em>.<br>
  ...
  <p style="color: #adbac7; font-size:1em;">Currently under active development. New features, performance improvements, and UI upgrades are coming soon.</p>

  <h2 style="color: #58a6ff; margin-bottom: 10px;">🚀 Why Lynky?</h2>
  <p style="color: #adbac7; font-size:1em;">
    Most chat apps focus on endless randomness.<br>
